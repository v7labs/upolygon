 ...
 *                 c += 1
 */
        __pyx_t_6 = __pyx_f_13find_contours_contour_trace(__pyx_v_px, __pyx_v_py, __pyx_v_c, __pyx_v_image, __pyx_v_labels, 0); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 92, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_XDECREF_SET(__pyx_v_path, __pyx_t_6);
        __pyx_t_6 = 0;

        /* "find_contours.pyx":93
 *                 labels[py][px] = c
 *                 path = contour_trace(px, py, c, image, labels, 0)
 *                 outer_paths.append(path)             # <<<<<<<<<<<<<<
 *                 c += 1
 ...
 */
          ...
          __pyx_t_6 = __pyx_f_13find_contours_contour_trace(__pyx_v_px, __pyx_v_py, (*((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_9 * __pyx_v_labels.strides[0]) ) + __pyx_t_10 * __pyx_v_labels.strides[1]) ))), __pyx_v_image, __pyx_v_labels, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 101, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __Pyx_XDECREF_SET(__pyx_v_path, __pyx_t_6);
          __pyx_t_6 = 0;
 ...
 */
        /*else*/ {
          __pyx_t_10 = __pyx_v_py;
          __pyx_t_9 = __pyx_v_px;
          __pyx_t_6 = __pyx_f_13find_contours_contour_trace(__pyx_v_px, __pyx_v_py, (*((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_10 * __pyx_v_labels.strides[0]) ) + __pyx_t_9 * __pyx_v_labels.strides[1]) ))), __pyx_v_image, __pyx_v_labels, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 103, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __Pyx_XDECREF_SET(__pyx_v_path, __pyx_t_6);
          __pyx_t_6 = 0;
        }
 ...
 */
  ...
  __pyx_t_3[6] = 0;
  __pyx_t_3[7] = 1;
  __pyx_v_13find_contours_directions_x = __pyx_t_3;

  /* "find_contours.pyx":14
 * # 3 2 1
 * cdef int* directions_x = [1, 1, 0, -1, -1, -1,  0,  1]
 * cdef int* directions_y = [0, 1, 1,  1,  0, -1, -1, -1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_4[6] = -1;
  __pyx_t_4[7] = -1;
  __pyx_v_13find_contours_directions_y = __pyx_t_4;
 ...
 *     cdef int py = 1
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_13find_contours_1find_contours, NULL, __pyx_n_s_find_contours); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);

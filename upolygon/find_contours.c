...
#define __PYX_HAVE__find_contours
#define __PYX_HAVE_API__find_contours
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'find_contours' */
static PyTypeObject *__pyx_array_type = 0;
static PyTypeObject *__pyx_MemviewEnum_type = 0;
static PyTypeObject *__pyx_memoryview_type = 0;
static PyTypeObject *__pyx_memoryviewslice_type = 0;
static int *__pyx_v_13find_contours_directions_x;
static int *__pyx_v_13find_contours_directions_y;
...
static int __pyx_f_13find_contours_tracer(int, int, int, int *, int *, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static PyObject *__pyx_f_13find_contours_contour_trace(int, int, int, __Pyx_memviewslice, __Pyx_memviewslice, int); /*proto*/
...
#define __Pyx_MODULE_NAME "find_contours"
extern int __pyx_module_is_main_find_contours;
int __pyx_module_is_main_find_contours = 0;

/* Implementation of 'find_contours' */
...
static PyObject *__pyx_pf_13find_contours_find_contours(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image); /* proto */
...
static int __pyx_f_13find_contours_tracer(int __pyx_v_px, int __pyx_v_py, int __pyx_v_old_index, int *__pyx_v_nx, int *__pyx_v_ny, __Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_labels) {
 ...
 */
    __pyx_v_tmpx = ((__pyx_v_13find_contours_directions_x[__pyx_v_i]) + __pyx_v_px);

    /* "find_contours.pyx":27
 *         i = i % 8
 *         tmpx = directions_x[i] + px
 *         tmpy = directions_y[i] + py             # <<<<<<<<<<<<<<
 *         if image[tmpy][tmpx] == 1:
 *             nx[0] = tmpx
 */
    __pyx_v_tmpy = ((__pyx_v_13find_contours_directions_y[__pyx_v_i]) + __pyx_v_py);

    /* "find_contours.pyx":28
 *         tmpx = directions_x[i] + px
 *         tmpy = directions_y[i] + py
 *         if image[tmpy][tmpx] == 1:             # <<<<<<<<<<<<<<
 *             nx[0] = tmpx
...
static PyObject *__pyx_f_13find_contours_contour_trace(int __pyx_v_px, int __pyx_v_py, int __pyx_v_c, __Pyx_memviewslice __pyx_v_image, __Pyx_memviewslice __pyx_v_labels, int __pyx_v_inner) {
  int __pyx_v_sx;
  int __pyx_v_sy;
  int __pyx_v_nx;
  int __pyx_v_ny;
 ...
 *         tx = nx
 */
  __pyx_t_2 = __Pyx_PyInt_From_long((__pyx_v_px - 1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_long((__pyx_v_py - 1)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 45, __pyx_L1_error)
 ...
 *         ty = ny
 */
  __pyx_v_index = __pyx_f_13find_contours_tracer(__pyx_v_px, __pyx_v_py, __pyx_v_index, (&__pyx_v_nx), (&__pyx_v_ny), __pyx_v_image, __pyx_v_labels);

  /* "find_contours.pyx":47
 *         path = [px-1, py-1]
 *         index = tracer(px, py, index, &nx, &ny, image, labels)
 *         tx = nx             # <<<<<<<<<<<<<<
 *         ty = ny
 ...
 * 
 */
  __pyx_t_6 = ((__pyx_v_tx == __pyx_v_sx) != 0);
  if (__pyx_t_6) {
  } else {
    __pyx_t_5 = __pyx_t_6;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_6 = ((__pyx_v_ty == __pyx_v_sy) != 0);
  __pyx_t_5 = __pyx_t_6;
  __pyx_L4_bool_binop_done:;
  if (__pyx_t_5) {

    /* "find_contours.pyx":52
 *         # S was a single point
 *         if tx == sx and ty == sy:
 *             return path             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_tx - 1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_path, __pyx_t_4); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "find_contours.pyx":55
 * 
 *         path.append(tx-1)
 *         path.append(ty-1)             # <<<<<<<<<<<<<<
 * 
 *         labels[ny][nx] = c
 */
  __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_ty - 1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_path, __pyx_t_4); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

  /* "find_contours.pyx":57
 *         path.append(ty-1)
 * 
 *         labels[ny][nx] = c             # <<<<<<<<<<<<<<
 *         while True:
 ...
 *                 return path
 */
    __pyx_v_index = __pyx_f_13find_contours_tracer(__pyx_v_nx, __pyx_v_ny, __pyx_v_index, (&__pyx_v_nx), (&__pyx_v_ny), __pyx_v_image, __pyx_v_labels);

    /* "find_contours.pyx":60
 *         while True:
 *             index = tracer(nx, ny, index, &nx, &ny, image, labels)
 *             if last_point_was_s and nx == tx and ny == ty:             # <<<<<<<<<<<<<<
 *                 return path
 *             path.append(nx-1)
 */
    __pyx_t_6 = (__pyx_v_last_point_was_s != 0);
    if (__pyx_t_6) {
    } else {
      __pyx_t_5 = __pyx_t_6;
      goto __pyx_L9_bool_binop_done;
    }
    __pyx_t_6 = ((__pyx_v_nx == __pyx_v_tx) != 0);
    if (__pyx_t_6) {
    } else {
      __pyx_t_5 = __pyx_t_6;
      goto __pyx_L9_bool_binop_done;
    }
    __pyx_t_6 = ((__pyx_v_ny == __pyx_v_ty) != 0);
    __pyx_t_5 = __pyx_t_6;
    __pyx_L9_bool_binop_done:;
    if (__pyx_t_5) {

      /* "find_contours.pyx":61
 *             index = tracer(nx, ny, index, &nx, &ny, image, labels)
 *             if last_point_was_s and nx == tx and ny == ty:
 *                 return path             # <<<<<<<<<<<<<<
 *             path.append(nx-1)
 ...
 *             labels[ny][nx] = c
 */
    __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_nx - 1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_path, __pyx_t_4); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

    /* "find_contours.pyx":63
 *                 return path
 *             path.append(nx-1)
 *             path.append(ny-1)             # <<<<<<<<<<<<<<
 *             labels[ny][nx] = c
 ...
 */
    __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_ny - 1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 63, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_7 = __Pyx_PyList_Append(__pyx_v_path, __pyx_t_4); if (unlikely(__pyx_t_7 == ((int)-1))) __PYX_ERR(0, 63, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;

    /* "find_contours.pyx":64
 *             path.append(nx-1)
 *             path.append(ny-1)
 *             labels[ny][nx] = c             # <<<<<<<<<<<<<<
 *             last_point_was_s = nx == sx and ny == sy
 ...
 */
    ...
    *((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_10 * __pyx_v_labels.strides[0]) ) + __pyx_t_11 * __pyx_v_labels.strides[1]) )) = __pyx_v_c;

    /* "find_contours.pyx":65
 *             path.append(ny-1)
 *             labels[ny][nx] = c
 *             last_point_was_s = nx == sx and ny == sy             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)
 */
    __pyx_t_5 = (__pyx_v_nx == __pyx_v_sx);
    if (__pyx_t_5) {
    } else {
      __pyx_t_1 = __pyx_t_5;
      goto __pyx_L12_bool_binop_done;
    }
    __pyx_t_5 = (__pyx_v_ny == __pyx_v_sy);
    __pyx_t_1 = __pyx_t_5;
 ...
 */
  ...
  __Pyx_AddTraceback("find_contours.contour_trace", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_13find_contours_1find_contours(PyObject *__pyx_self, PyObject *__pyx_arg_image); /*proto*/
static PyMethodDef __pyx_mdef_13find_contours_1find_contours = {"find_contours", (PyCFunction)__pyx_pw_13find_contours_1find_contours, METH_O, 0};
static PyObject *__pyx_pw_13find_contours_1find_contours(PyObject *__pyx_self, PyObject *__pyx_arg_image) {
  ...
  assert(__pyx_arg_image); {
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(__pyx_arg_image, PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 70, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("find_contours.find_contours", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13find_contours_find_contours(__pyx_self, __pyx_v_image);
...
static PyObject *__pyx_pf_13find_contours_find_contours(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image) {
  int __pyx_v_px;
  int __pyx_v_py;
  int __pyx_v_c;
  int __pyx_v_width;
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_pad); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_image, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_pad_width, __pyx_int_1) < 0) __PYX_ERR(0, 76, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_mode, __pyx_n_u_constant) < 0) __PYX_ERR(0, 76, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_constant_values, __pyx_int_0) < 0) __PYX_ERR(0, 76, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyInt_FromSsize_t((__pyx_v_image.shape[0])); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = PyInt_FromSsize_t((__pyx_v_image.shape[1])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_int8); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 77, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dsds_char(__pyx_t_6, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_v_labels = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "find_contours.pyx":78
 *     image = np.pad(image, pad_width=1, mode='constant', constant_values=0)
 *     cdef char[:,:] labels = np.zeros((image.shape[0], image.shape[1]), dtype=np.int8)
 *     inner_paths = []             # <<<<<<<<<<<<<<
 *     outer_paths = []
 ...
 *                 c += 1
 */
        __pyx_t_6 = __pyx_f_13find_contours_contour_trace(__pyx_v_px, __pyx_v_py, __pyx_v_c, __pyx_v_image, __pyx_v_labels, 0); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 89, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_XDECREF_SET(__pyx_v_path, __pyx_t_6);
        __pyx_t_6 = 0;

        /* "find_contours.pyx":90
 *                 labels[py][px] = c
 *                 path = contour_trace(px, py, c, image, labels, 0)
 *                 outer_paths.append(path)             # <<<<<<<<<<<<<<
 *                 c += 1
 *                 handled = True
 */
        __pyx_t_12 = __Pyx_PyList_Append(__pyx_v_outer_paths, __pyx_v_path); if (unlikely(__pyx_t_12 == ((int)-1))) __PYX_ERR(0, 90, __pyx_L1_error)

        /* "find_contours.pyx":91
 *                 path = contour_trace(px, py, c, image, labels, 0)
 *                 outer_paths.append(path)
 *                 c += 1             # <<<<<<<<<<<<<<
 *                 handled = True
 ...
 *                 # unlabeled
 */
      __pyx_t_13 = (__pyx_v_py + 1);
      __pyx_t_14 = __pyx_v_px;
      __pyx_t_11 = (((*((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_13 * __pyx_v_labels.strides[0]) ) + __pyx_t_14 * __pyx_v_labels.strides[1]) ))) != -1L) != 0);
      if (__pyx_t_11) {
      } else {
        __pyx_t_8 = __pyx_t_11;
        goto __pyx_L14_bool_binop_done;
      }
      __pyx_t_14 = (__pyx_v_py + 1);
      __pyx_t_13 = __pyx_v_px;
      __pyx_t_11 = (((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_14 * __pyx_v_image.strides[0]) ) + __pyx_t_13 * __pyx_v_image.strides[1]) ))) == 0) != 0);
      __pyx_t_8 = __pyx_t_11;
      __pyx_L14_bool_binop_done:;
      if (__pyx_t_8) {

        /* "find_contours.pyx":95
 *             # STEP 2
 *             if labels[py+1][px] != -1 and image[py+1][px] == 0:
 *                 handled = True             # <<<<<<<<<<<<<<
 *                 # unlabeled
 ...
 */
        ...
        __pyx_t_14 = __pyx_v_px;
        __pyx_t_8 = (((*((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_13 * __pyx_v_labels.strides[0]) ) + __pyx_t_14 * __pyx_v_labels.strides[1]) ))) == 0) != 0);
        if (__pyx_t_8) {

          /* "find_contours.pyx":98
 *                 # unlabeled
 *                 if labels[py][px] == 0:
 *                     path = contour_trace(px, py, labels[py][px-1], image, labels, 1)             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
          ...
          __pyx_t_13 = (__pyx_v_px - 1);
          __pyx_t_6 = __pyx_f_13find_contours_contour_trace(__pyx_v_px, __pyx_v_py, (*((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_14 * __pyx_v_labels.strides[0]) ) + __pyx_t_13 * __pyx_v_labels.strides[1]) ))), __pyx_v_image, __pyx_v_labels, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 98, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __Pyx_XDECREF_SET(__pyx_v_path, __pyx_t_6);
          __pyx_t_6 = 0;
 ...
 */
        /*else*/ {
          __pyx_t_13 = __pyx_v_py;
          __pyx_t_14 = __pyx_v_px;
          __pyx_t_6 = __pyx_f_13find_contours_contour_trace(__pyx_v_px, __pyx_v_py, (*((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_13 * __pyx_v_labels.strides[0]) ) + __pyx_t_14 * __pyx_v_labels.strides[1]) ))), __pyx_v_image, __pyx_v_labels, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 100, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          __Pyx_XDECREF_SET(__pyx_v_path, __pyx_t_6);
          __pyx_t_6 = 0;
        }
 ...
 */
        __pyx_t_12 = __Pyx_PyList_Append(__pyx_v_inner_paths, __pyx_v_path); if (unlikely(__pyx_t_12 == ((int)-1))) __PYX_ERR(0, 101, __pyx_L1_error)
 ...
 */
      ...
      __pyx_t_14 = __pyx_v_py;
      __pyx_t_13 = __pyx_v_px;
      __pyx_t_11 = (((*((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_14 * __pyx_v_labels.strides[0]) ) + __pyx_t_13 * __pyx_v_labels.strides[1]) ))) == 0) != 0);
      __pyx_t_8 = __pyx_t_11;
      __pyx_L18_bool_binop_done:;
      if (__pyx_t_8) {

        /* "find_contours.pyx":104
 *             # STEP 3
 *             if not handled and labels[py][px] == 0:
 *                 labels[py][px] = labels[py][px-1]             # <<<<<<<<<<<<<<
 *         px += 1
 ...
 */
        __pyx_t_13 = __pyx_v_py;
        __pyx_t_14 = (__pyx_v_px - 1);
        __pyx_t_15 = __pyx_v_py;
        __pyx_t_16 = __pyx_v_px;
        *((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_15 * __pyx_v_labels.strides[0]) ) + __pyx_t_16 * __pyx_v_labels.strides[1]) )) = (*((char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_labels.data + __pyx_t_13 * __pyx_v_labels.strides[0]) ) + __pyx_t_14 * __pyx_v_labels.strides[1]) )));
 ...
 */
  ...
  /* "find_contours.pyx":109
 *             px = 1
 *             py = py + 1
 *     return labels, outer_paths, inner_paths             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_6 = __pyx_memoryview_fromslice(__pyx_v_labels, 2, (PyObject *(*)(char *)) __pyx_memview_get_char, (int (*)(char *, PyObject *)) __pyx_memview_set_char, 0);; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 109, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "find_contours.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "find_contours._memoryviewslice", /*tp_name*/
 ...
 *     cdef int py = 1
 */
  __pyx_tuple__19 = PyTuple_Pack(12, __pyx_n_s_image, __pyx_n_s_image, __pyx_n_s_px, __pyx_n_s_py, __pyx_n_s_c, __pyx_n_s_width, __pyx_n_s_height, __pyx_n_s_labels, __pyx_n_s_inner_paths, __pyx_n_s_outer_paths, __pyx_n_s_handled, __pyx_n_s_path); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(1, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_upolygon_find_contours_pyx, __pyx_n_s_find_contours, 70, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 70, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_find_contours) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "find_contours")) {
      if (unlikely(PyDict_SetItemString(modules, "find_contours", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __pyx_t_2[6] = 0;
  __pyx_t_2[7] = 1;
  __pyx_v_13find_contours_directions_x = __pyx_t_2;

  /* "find_contours.pyx":13
 * # 3 2 1
 * cdef int* directions_x = [1, 1, 0, -1, -1, -1,  0,  1]
 * cdef int* directions_y = [0, 1, 1,  1,  0, -1, -1, -1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_3[6] = -1;
  __pyx_t_3[7] = -1;
  __pyx_v_13find_contours_directions_y = __pyx_t_3;
 ...
 *     cdef int py = 1
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_13find_contours_1find_contours, NULL, __pyx_n_s_find_contours); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_find_contours, __pyx_t_1) < 0) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init find_contours", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init find_contours");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT

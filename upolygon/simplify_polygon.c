 ...
 */
  /*else*/ {
    ...
    PyList_SET_ITEM(__pyx_t_3, 0, PyList_GET_ITEM(__pyx_v_path, 0));
    __Pyx_INCREF(PyList_GET_ITEM(__pyx_v_path, 1));
    __Pyx_GIVEREF(PyList_GET_ITEM(__pyx_v_path, 1));
    PyList_SET_ITEM(__pyx_t_3, 1, PyList_GET_ITEM(__pyx_v_path, 1));
    __Pyx_INCREF(PyList_GET_ITEM(__pyx_v_path, __pyx_t_11));
    __Pyx_GIVEREF(PyList_GET_ITEM(__pyx_v_path, __pyx_t_11));
    PyList_SET_ITEM(__pyx_t_3, 2, PyList_GET_ITEM(__pyx_v_path, __pyx_t_11));
    __Pyx_INCREF(PyList_GET_ITEM(__pyx_v_path, __pyx_t_18));
    __Pyx_GIVEREF(PyList_GET_ITEM(__pyx_v_path, __pyx_t_18));
    PyList_SET_ITEM(__pyx_t_3, 3, PyList_GET_ITEM(__pyx_v_path, __pyx_t_18));
    __pyx_r = __pyx_t_3;
    __pyx_t_3 = 0;
    goto __pyx_L0;
  }
